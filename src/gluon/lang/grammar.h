...
struct ExprType {
  enum Enum { kBinary, kGrouping, kLiteral, kUnary, kVariable, kAssign };
};
...
class Expr {
 public:
  NONCOPYABLE(Expr);
  NONMOVEABLE(Expr);
  explicit Expr(ExprType::Enum expr_type) : m_type(expr_type) {}
...
class GroupingExpr : public Expr {
 public:
  explicit GroupingExpr(ExprPtr expr)
      : Expr{ExprType::kGrouping}, m_expr{std::move(expr)} {}
...
class LiteralExpr : public Expr {
 public:
  explicit LiteralExpr(Value value)
      : Expr{ExprType::kLiteral}, m_value{value} {}
...
class VariableExpr : public Expr {
 public:
  explicit VariableExpr(Token name)
      : Expr{ExprType::kVariable}, m_name{std::move(name)} {}
...
class Stmt {
 public:
  ...
  explicit Stmt(StmtType::Enum stmt_type) : m_type{stmt_type} {}
...
class ExprStmt : public Stmt {
 public:
  explicit ExprStmt(ExprPtr expr)
      : Stmt{StmtType::kExpr}, m_expr{std::move(expr)} {}
...
class PrintStmt : public Stmt {
 public:
  explicit PrintStmt(std::initializer_list<ExprPtr> exprs)
      : Stmt{StmtType::kPrint}, m_exprs{exprs} {}
...
class BlockStmt : public Stmt {
 public:
  explicit BlockStmt(std::initializer_list<StmtPtr> stmts)
      : Stmt{StmtType::kBlock}, m_stmts{stmts} {}
