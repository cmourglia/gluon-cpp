...
struct Node {
  explicit Node(NodeType::Enum type) : type{type} {}
...
struct ConstantNode : public Node {
  explicit ConstantNode(f32 value = 0.0f)
      : Node{NodeType::kConstant}, constant{value} {}
...
struct OperatorNode : public Node {
  OperatorNode(Operator::Enum op, bool unary)
      : Node(NodeType::kOperator), op{op}, unary{unary} {}
...
struct FunctionNode : public Node {
  FunctionNode(Function::Enum function, Widget* widget)
      : Node{NodeType::kFunction}, function{function}, widget{widget} {}
...
struct Expression {
  ...
  static Expression Build(const beard::array<Token>& tokens,
                          Widget* root_widget,
